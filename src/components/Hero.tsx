      ...
      <div className="absolute inset-0 bg-black">
        <div
          ...
          style={{
            ...
            backgroundPosition: isMobile ? '-220px center' : 'center', // Aplica el desplazamiento solo en modo móvil
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/20 to-black" />
      </div>

      <div className={`section-container w-full px-4 sm:px-6 lg:px-8 relative z-10 ${isMobile ? 'mt-[80px]' : 'mt-[150px]'}`}>
