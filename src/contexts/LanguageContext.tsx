...
const translations = {
  en: {
    ...
    "services.privateJet.description": "Access to a global fleet of high-end private jets for your travel needs with no ownership commitment.",
    "services.groupCharters.title": "Group Charters",
    "services.groupCharters.description": "Specialized solutions for corporate travel, sports teams, music tours, and more.",
    "services.events.title": "Events & Occasions",
    "services.events.description": "Special packages for important life events, anniversaries, and exclusive gatherings.",
    "services.safety.title": "Safety",
    "services.safety.description": "Vgoldenjets has been providing aircraft charter services since 2018 with an impeccable safety record (Argus Gold). Our air charter crews are highly trained professionals and we maintain our aircraft to the highest standards.",
    ...
    "reasons.luxury.description": "Flying should be a pleasure and we'll make your charter experience as luxurious and comfortable as possible.",
    "reasons.discretion.title": "Discretion and Security",
    "reasons.discretion.description": "Vgoldenjets guarantees your privacy, and we will work closely with your security provider on all aspects of your charter.",
    "reasons.schedule.title": "Create Your Schedule",
    "reasons.schedule.description": "Connect with commercial flights or fly to your bespoke timetable – whatever your requirements, we'll create the private jet charter to suit you.",
  ...
  "contact.toast.description": "Thank you for your inquiry. We'll get back to you shortly.",
    ...
    "footer.companyInfo": "Experience luxury private aviation with a fleet of modern aircraft and exceptional service."
  },
  es: {
    // Navbar
    "nav.home": "Inicio",
    ...
    "services.privateJet.description": "Acceso a una flota global de jets privados de alta gama para sus necesidades de viaje sin compromiso de propiedad.",
    "services.groupCharters.title": "Charters Grupales",
    "services.groupCharters.description": "Soluciones especializadas para viajes corporativos, equipos deportivos, giras musicales y más.",
    "services.events.title": "Eventos y Ocasiones",
    "services.events.description": "Paquetes especiales para eventos importantes de la vida, aniversarios y reuniones exclusivas.",
    "services.safety.title": "Seguridad",
    "services.safety.description": "Vgoldenjets ha estado proporcionando servicios de charter de aeronaves desde 2018 con un historial de seguridad impecable (Argus Gold). Nuestras tripulaciones de charter aéreo son profesionales altamente capacitados y mantenemos nuestras aeronaves con los más altos estándares.",
    ...
    "reasons.luxury.description": "Volar debe ser un placer y haremos que su experiencia de charter sea lo más lujosa y cómoda posible.",
    "reasons.discretion.title": "Discreción y Seguridad",
    "reasons.discretion.description": "Vgoldenjets garantiza su privacidad y trabajaremos estrechamente con su proveedor de seguridad en todos los aspectos de su charter.",
    "reasons.schedule.title": "Cree Su Horario",
    "reasons.schedule.description": "Conéctese con vuelos comerciales o vuele según su horario personalizado – cualesquiera que sean sus requisitos, crearemos el charter de jet privado que se adapte a usted.",
    ...
    "fleet.lightJets.description": "Los jets ligeros proporcionan un rango de vuelo de alrededor de tres a cinco horas, cubriendo aproximadamente 1,600 millas náuticas. Ideales para pistas cortas, estos jets son perfectos para viajes de negocios o vacaciones, ofreciendo fácil acceso a aeropuertos limitados.",
    "fleet.midSizeJets.title": "Jets de Tamaño Medio",
    "fleet.midSizeJets.description": "Los jets de tamaño medio típicamente proporcionan una duración de vuelo de cuatro a cinco horas, cubriendo aproximadamente 2,800 millas náuticas. Mientras que algunos son capaces de vuelos sin escalas de costa a costa, otros pueden requerir una breve parada para repostar. La versatilidad de los jets de tamaño medio los hace muy adecuados para viajes cómodos y convenientes de costa a costa.",
    "fleet.heavyJets.title": "Jets Pesados",
    "fleet.heavyJets.description": "Al seleccionar un charter de jet privado, los jets pesados destacan por su alcance extendido y mayor espacio interior en comparación con sus contrapartes más pequeñas. Para charters de jets VIP, también hay jets pesados de ultra largo alcance que proporcionan el pináculo del lujo, cerrando la brecha entre jets privados y aerolíneas ejecutivas.",
  ...
  "contact.toast.description": "Gracias por tu consulta. Te responderemos pronto.",
    ...
    "footer.companyInfo": "Experimente la aviación privada de lujo con una flota de aeronaves modernas y un servicio excepcional."
  }
};
